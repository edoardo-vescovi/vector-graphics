...
int LoadGLTextures()									// Load Bitmaps And Convert To Textures
{
	...
	if (TextureImage[0]=LoadBMP("fractals.bmp"))
	{
...
int DrawGLScene(GLvoid)									// Here's Where We Do All The Drawing
{
    ...
    glLoadIdentity();
    glTranslatef(0+7*cos(Time),-3,-15+9*sin(Time));
    glRotatef(Time*100,1,2,3);
					...
					int			nCmdShow)			// Window Show State
{
	...
	if (!CreateGLWindow("Cubo in orbita",640,480,16,fullscreen))
	{
